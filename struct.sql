...
DROP TABLE IF EXISTS `marker_pooling`;
CREATE TABLE IF NOT EXISTS `marker_pooling` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `categorie` varchar(150) DEFAULT NULL,
  `ninseeCode` int(11) DEFAULT NULL,
  `nbreplac` int(11) DEFAULT NULL,
  `typeAir` varchar(150) DEFAULT NULL,
  `coteRoute` int(11) DEFAULT NULL,
